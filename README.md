...
- [1] ```bash {{ Deploy Full }} ``` : Push New Commit file with GIT FTP, and Auto run command php artisan down, php artisan optimize, view:clear, view:cache finally php artisan up 
